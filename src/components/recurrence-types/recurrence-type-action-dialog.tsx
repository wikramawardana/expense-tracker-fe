...
} from "@/services/recurrence-types.service";
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p
                  className={`font-medium ${recurrenceType.is_active ? "text-green-600" : "text-gray-500"}`}
                >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium">
                  {formatDate(recurrenceType.created_at)}
                </p>
              </div>
              <div>
                <Label className="text-muted-foreground">Updated</Label>
                <p className="font-medium">
                  {formatDate(recurrenceType.updated_at)}
                </p>
              </div>
            </div>
            {recurrenceType.description && (
