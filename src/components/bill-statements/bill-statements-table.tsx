...
export function BillStatementsTable({
    ...
    const columns = React.useMemo<ColumnDef<BillStatement>[]>(
        () => [
            ...
            },
            {
                ...
                header: () => <div className="text-left font-semibold">Statement Date</div>,
                cell: ({ row }) => {
            ...
            },
            {
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <div className={`text-left ${isOverdue ? "text-red-600 font-bold" : "text-gray-600 dark:text-gray-400"}`}>
                            {date ? formatDate(date) : "-"}
                        </div>
                    );
                },
        ...
        return (
            <div className="border-3 border-foreground shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,251,245,1)] bg-background">
                <div className="p-8 text-center">
                    ...
                    <p className="mt-2 text-sm font-bold text-muted-foreground uppercase">Loading bill statements...</p>
                </div>
            </div>
        );
    }
    ...
    if (billStatements.length === 0) {
        return (
            <div className="border-3 border-foreground shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,251,245,1)] bg-background">
                <div className="p-8 text-center">
                    <p className="text-lg font-black uppercase">No bill statements found</p>
