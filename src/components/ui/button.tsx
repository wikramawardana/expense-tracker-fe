...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium transition-all border-2 shadow-[3px_3px_0px_0px_rgba(0,0,0,0.9)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,0.9)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,0.9)] dark:hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.9)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-[1px_1px_0px_0px_rgba(0,0,0,0.9)] dark:active:shadow-[1px_1px_0px_0px_rgba(255,255,255,0.9)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "border-foreground bg-primary text-primary-foreground hover:bg-primary/90 active:bg-primary/95",
        destructive:
        ...
        ghost:
          "text-foreground hover:bg-muted hover:text-foreground border-transparent shadow-none dark:shadow-none hover:shadow-none dark:hover:shadow-none hover:translate-x-0 hover:translate-y-0",
