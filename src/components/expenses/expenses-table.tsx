...
import { StatusBadge, CategoryBadge, PaymentMethodBadge } from "./status-badge";
        ...
        return (
            <div className="border-3 border-foreground shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,251,245,1)] bg-background">
                <div className="p-8 text-center">
                    ...
                    <p className="mt-2 text-sm font-bold text-muted-foreground uppercase">Loading expenses...</p>
                </div>
            </div>
        );
    }
