...
export function RecurrenceTypesTable({
    ...
    const columns = React.useMemo<ColumnDef<RecurrenceType>[]>(
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <div className="text-left text-gray-500 dark:text-gray-400 max-w-[300px] truncate">
        ...
        return (
            <div className="border-3 border-foreground shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,251,245,1)] bg-background">
                <div className="p-8 text-center">
                    ...
                    <p className="mt-2 text-sm font-bold text-muted-foreground uppercase">Loading recurrence types...</p>
                </div>
            </div>
        );
    }
    ...
    if (recurrenceTypes.length === 0) {
        return (
            <div className="border-3 border-foreground shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,251,245,1)] bg-background">
                <div className="p-8 text-center">
                    <p className="text-lg font-black uppercase">No recurrence types found</p>
                    <p className="text-sm font-bold text-muted-foreground">
                        Start by adding your first recurrence type
                    </p>
                </div>
            </div>
        );
